...
/**
 * trilatération : Batman doit chercher une bombe dans un tableau 2D
 * entre deux sauts il n'a que droit aux infos : "S'EST RAPPROCHE" ou "S'EST ELOIGNE" ou "MEME DISTANCE"
 */
...
int main()
{
    ...
    while (1) {
        ...
        // Solution simple : peu de fenetres
        ...
        else { // temps de calcul trop long
            if (BOMB_DIST == "WARMER") {
